function Startquery() {
  ...
  if (hero.length == 0) {
    ...
    var url =
      "https://www.sapi.run/hero/select.php?hero=" + hero + "&type=" + type;
    $.ajax({
      url: url,
      type: "get",
      headers: {
      ...
      success: function (res) {
        if (res.code == 200) {
          var html =
            '<div class="panel panel-primary"><div class="panel-heading" style="background: linear-gradient(to right,#b221ff,#14b7ff,#8ae68a);"><center><font color="#000000"><b> 查询结果展示 </b></font></center></div>';
          ...
          html =
            html + '<td class="success">' + res.data.provincePower + "</td>";
          html = html + "</tr>";
